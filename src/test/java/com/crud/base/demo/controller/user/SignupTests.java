...
public class SignupTests {
    ...
    public void dreamSinup() throws Exception {
        ...
        userObject.put("password_confirmation", dreamSignupUser.getPassword());
    ...
    public void signupWhenUserAlreadyExists() throws Exception {
        ...
        userObject.put("password_confirmation", alreadyUser.getPassword());
    ...
    public void whenUserAdminSetted() throws Exception {
        ...
        userObject.put("password_confirmation", adminSettedSignupUser.getPassword());
